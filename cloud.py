...
client_id="" # get a valid one from your Arduino account
client_secret="" # get a valid one from your Arduino account
        ...
        for thing in things:
           ...
           # print(f"Found thing: {tname}")
            ...
            for property in properties:
                ...
                ptype.add(property.type)
                value.append(property.last_value)
